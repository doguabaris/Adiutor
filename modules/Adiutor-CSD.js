...
function callBack() {
	...
	api.get({
		...
		SpeedyDeletionRequestDialog.prototype.initialize = function () {
			...
			const copyVioInput = new OO.ui.TextInputWidget({
			...
			const generalReasons = new OO.ui.FieldsetLayout({
			...
			let selectedNamespaceForOthers = null;
			for (i = 0; i < speedyDeletionReasons.length; i++) {
			...
			const otherReasons = new OO.ui.FieldsetLayout({
