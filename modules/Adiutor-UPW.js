...
/**
 * @file Adiutor-UPW.js
 * @description Userpage widget module displaying user rights and metadata, adapted from existing tools.
 * @license CC BY-SA 4.0
 * @see https://meta.wikimedia.org/wiki/Adiutor
 * @see https://en.wikipedia.org/wiki/User:Fran_Rogers/dimorphism.js
 * @see https://en.wikipedia.org/wiki/User:Splarka/sysopdectector.js
 * @see https://en.wikipedia.org/wiki/User:PleaseStand/userinfo.js
